    ...
    public partial class Reservation : Form
    {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    addobj = new addstaff(txtBoxFirst.Text, txtBoxLast.Text, txtBoxEmail.Text, txtBoxUsername.Text, genValue, "Manager");
        ...
        {
            editobj = new editstaff(txtBoxFindUser.Text, "Manager");
            if (editobj.GetUser())
            {
        ...
        {
            if (editstaff.EditCol(ColVal, txtBoxFindUser.Text, txtBoxUpdateData.Text, "Manager"))
            {
