...
namespace Assignment {
    ...
    public partial class StaffDataSet : global::System.Data.DataSet {
        ...
        public partial class staffDataTable : global::System.Data.TypedTableBase<staffRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public staffRow AddstaffRow(string First_Name, string Last_Name, string Username, string Email, string Gender, string Password, string Role) {
...
namespace Assignment.StaffDataSetTableAdapters {
    ...
    public partial class staffTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[staff] WHERE (([Id] = @Original_Id) AND ([First_Name] = @Original_First_Name) AND ([Last_Name] = @Original_Last_Name) AND ([Username] = @Original_Username) AND ([Email] = @Original_Email) AND ([Gender] = @Original_Gender) AND ([Password] = @Original_Password) AND ([Role] = @Original_Role))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[staff] ([Id], [First_Name], [Last_Name], [Username], [Email], [Gender], [Password], [Role]) VALUES (@Id, @First_Name, @Last_Name, @Username, @Email, @Gender, @Password, @Role);
SELECT Id, First_Name, Last_Name, Username, Email, Gender, Password, Role FROM staff WHERE (Username = @Username)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[staff] SET [Id] = @Id, [First_Name] = @First_Name, [Last_Name] = @Last_Name, [Username] = @Username, [Email] = @Email, [Gender] = @Gender, [Password] = @Password, [Role] = @Role WHERE (([Id] = @Original_Id) AND ([First_Name] = @Original_First_Name) AND ([Last_Name] = @Original_Last_Name) AND ([Username] = @Original_Username) AND ([Email] = @Original_Email) AND ([Gender] = @Original_Gender) AND ([Password] = @Original_Password) AND ([Role] = @Original_Role));
SELECT Id, First_Name, Last_Name, Username, Email, Gender, Password, Role FROM staff WHERE (Username = @Username)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Assignment.Properties.Settings.Default.con;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, First_Name, Last_Name, Username, Email, Gender, Password, Role FROM db" +
                "o.staff";
        ...
        public virtual int Delete(int Original_Id, string Original_First_Name, string Original_Last_Name, string Original_Username, string Original_Email, string Original_Gender, string Original_Password, string Original_Role) {
        ...
        public virtual int Insert(int Id, string First_Name, string Last_Name, string Username, string Email, string Gender, string Password, string Role) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Id, string First_Name, string Last_Name, string Email, string Gender, string Password, string Role, int Original_Id, string Original_First_Name, string Original_Last_Name, string Original_Username, string Original_Email, string Original_Gender, string Original_Password, string Original_Role) {
            return this.Update(Id, First_Name, Last_Name, Original_Username, Email, Gender, Password, Role, Original_Id, Original_First_Name, Original_Last_Name, Original_Username, Original_Email, Original_Gender, Original_Password, Original_Role);
        }
    }
